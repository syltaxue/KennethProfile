			...
			<div className = "navigator-carousel">
				<Carousel>
					...
					<Carousel.Item>
						...
						<Carousel.Caption>
							<div className="pic-text-margin text-header font-size-xlarge xs-font-medium animated zoomIn">Work Preference: Big Data & Cloud Computing</div>
							<div className="pic-text-margin margin-divier font-size-larger xs-font-small animated zoomInDown Delay1s">I believe, the apps and devices tend to provide more and more personalized services</div>
							<div className="pic-text-margin font-size-larger xs-font-small animated zoomInRight Delay2s">Data Mining, Machine Learning, and Data Visualization are becoming popular</div>
					...
					<Carousel.Item>
						...
						<Carousel.Caption>
							<div className="pic-text-padding text-header font-size-xlarge xs-font-medium animated bounceInDown">Work Perference: AI & Machine Learning</div>
							<div className="pic-text-padding margin-divier font-size-larger xs-font-small animated bounceInDown Delay1s">I beleive AI applications will become more and more common in our life</div>
							<div className="pic-text-padding font-size-larger xs-font-small animated bounceInDown Delay1s">I believe Machine learning will be applied in most applications</div>
